...
<body>
    ...
    <?php
        include_once ___INC___."header.php";
    ?>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="min-height: 100vh;">
                    <img class="position-absolute w-100 h-100" <?=img('carousel-1.jpg')?> style="object-fit: cover;">
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img class="position-absolute w-100 h-100" <?=img('carousel-2.jpg')?> style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    <img class="position-absolute w-100 h-100" <?=img('carousel-3.jpg')?> style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="text-white text-uppercase mb-3 animate__animated animate__fadeInDown" style="letter-spacing: 3px;">Spa & Beauty Center</h6>
    ...
    <div class="container-fluid px-0 py-5 my-5">
        ...
        <div class="owl-carousel service-carousel">
            <div class="service-item position-relative">
                <img class="img-fluid" <?=img('service-1.jpg')?> alt="">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" <?=img('service-2.jpg')?> alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" <?=img('service-3.jpg')?> alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" <?=img('service-4.jpg')?> alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" <?=img('service-5.jpg')?> alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" <?=img('service-6.jpg')?> alt="">
                <div class="service-text text-center">
    ...
    <?php
        ...
        include_once ___INC___."footer.php"
