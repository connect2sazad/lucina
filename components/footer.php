        ...
        <div class="row">
            <div class="col-lg-6 pr-lg-5 mb-5">
                <a href="." class="navbar-brand">
                    <h1 class="mb-3 quicksand text-white" style="font-size: 38px;"><span class="text-primary"><?= data('project') ?></span></h1>
                </a>
                ...
                <p style="font-size: 20px;">Mentions légales</p>
                <p style="font-size: 12px;">
                    ...
                    SIRET : 878 790 765 0019 <br>
                    TVA intracommunautaire : FR92878790765 <br><br>

                    Site hébergé par Ionos SARL <br>
