<div class="container-fluid py-5 animate-image-bg">
    <!-- Add your video file path to the 'src' attribute -->
    <!-- <video class="video-background" autoplay loop muted>
        <source src="assets/img/triple-expertise/video.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video> -->
    <img <?= img('triple-expertise/te.jpg') ?> class="video-background">
    <div class="container py-5">
        <div class="row flex-column justify-center align-items-center">
            ...
            <div class="card col-md-8 col-sm-12 col-xs-12">
                <div class="card-body">
                    <h5 class="mb-3">UN MATÉRIEL CERTIFIÉ ET UN PRATICIEN QUALIFIÉ À VOTRE ÉCOUTE</h1>
                </div>
            </div>
        </div>
    </div>
